...
<html>
    ...
    <head>
        <title>COD BLACK OPS 4 - DUELO POR EQUIPOS</title>
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
        <link rel="stylesheet" href="assets/css/main_5.css" />
    ...
    <body class="is-preload">
        ...
        <div id="page-wrapper">
            ...
            <article id="main">
                <header>
                    <h2>DUELO POR EQUIPOS</h2>
                    <p>Inscribe a tu SQUAD en la liga de DUELO POR EQUIPOS</p>
                </header>
